# Gabriel \| Java Backend Developer
...
-   **Prioridade:** Baixa\
-   **Prazo:** Indefinido\
-   **Observação:** Necessita reestruturação da arquitetura e
...
-   **Papel:** Gerente de Projeto no grupo MBS (ramificação da IEEE)\
-   **Foco atual:** Correção de bugs, documentação técnica e onboarding
    de novos colaboradores\
-   **Objetivo:** Tornar o projeto totalmente open source e acessível\
-   **Contexto:** Ferramenta de acessibilidade para pessoas surdas,
...
-   **Participação:** Contribuição na criação de componentes e estrutura
    do sistema\
-   Quando liberado oficialmente, a participação será detalhada com
    links públicos.
